...
const COLUMNS: { id: HomologationStatus; title: string; color: string; headerColor: string }[] = [
  ...
  { id: 'Approved', title: 'Concluindo', color: 'bg-emerald-50/80 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800/50', headerColor: 'text-emerald-700 dark:text-emerald-400' },
];
